...
#elif DEPLOYMENT_TARGET_EMBEDDED || DEPLOYMENT_TARGET_EMBEDDED_MINI || DEPLOYMENT_TARGET_WINDOWS || DEPLOYMENT_TARGET_LINUX || DEPLOYMENT_TARGET_FREEBSD || TARGET_OS_CYGWIN
...
#if DEPLOYMENT_TARGET_LINUX || DEPLOYMENT_TARGET_MACOSX || TARGET_OS_CYGWIN
...
#if DEPLOYMENT_TARGET_LINUX || DEPLOYMENT_TARGET_FREEBSD || TARGET_OS_CYGWIN
...
#elif DEPLOYMENT_TARGET_LINUX || DEPLOYMENT_TARGET_MACOSX || TARGET_OS_CYGWIN
        __CFTSDInitialize();
#endif
