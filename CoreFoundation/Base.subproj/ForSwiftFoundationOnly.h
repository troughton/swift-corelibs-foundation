...
CF_EXPORT void _cf_uuid_clear(_Null_unspecified _cf_uuid_t uu);
CF_EXPORT int _cf_uuid_compare(const _Null_unspecified _cf_uuid_t uu1, const _Null_unspecified _cf_uuid_t uu2);
CF_EXPORT void _cf_uuid_copy(_Null_unspecified _cf_uuid_t dst, const _Null_unspecified _cf_uuid_t src);
CF_EXPORT void _cf_uuid_generate(_Null_unspecified _cf_uuid_t out);
CF_EXPORT void _cf_uuid_generate_random(_Null_unspecified _cf_uuid_t out);
CF_EXPORT void _cf_uuid_generate_time(_Null_unspecified _cf_uuid_t out);
CF_EXPORT int _cf_uuid_is_null(const _Null_unspecified _cf_uuid_t uu);
CF_EXPORT int _cf_uuid_parse(const _Null_unspecified _cf_uuid_string_t in, _Null_unspecified _cf_uuid_t uu);
CF_EXPORT void _cf_uuid_unparse(const _Null_unspecified _cf_uuid_t uu, _Null_unspecified _cf_uuid_string_t out);
CF_EXPORT void _cf_uuid_unparse_lower(const _Null_unspecified _cf_uuid_t uu, _Null_unspecified _cf_uuid_string_t out);
CF_EXPORT void _cf_uuid_unparse_upper(const _Null_unspecified _cf_uuid_t uu, _Null_unspecified _cf_uuid_string_t out);
